...
### data
from train.data_custom import data_provider

### Model
from model.NST import non_stationary_transformer
...
class Exp_Main(Exp_Basic):
    def __init__(self, config):
        super(Exp_Main, self).__init__(config)

    def _build_model(self):
        model_dict = {
            'ns_Transformer': non_stationary_transformer,

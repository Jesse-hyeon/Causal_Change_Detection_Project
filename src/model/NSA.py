...
from src.utils.embed import DataEmbedding_wo_pos
from src.utils.nsfomer_class import DSAutoCorrelation, AutoCorrelationLayer, EncoderLayer, Encoder, DecoderLayer, Decoder, my_Layernorm, series_decomp


class ns_autoformer_model(nn.Module):
    """
    ...
    def __init__(self, configs):
        super(ns_autoformer_model, self).__init__()
